      ...
      <main className="flex-1 p-4 md:p-8">
        <Card>
          ...
          <CardContent className="prose dark:prose-invert max-w-none space-y-4">
            ...
            <p>
              Some parts of the Service are billed on a subscription basis. You will be billed in advance on a recurring and periodic basis. Subscriptions automatically renew unless canceled. You can manage your subscription through the Stripe Customer Portal, accessible via your account settings.
            </p>
