...
import { simulateInvestmentScenariosAction } from '@/app/actions/invest-actions';
import type { SimulateInvestmentScenariosOutput } from '@/ai/flows/simulate-investment-scenarios';
